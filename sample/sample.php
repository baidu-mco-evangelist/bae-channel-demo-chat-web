...
function test_pushMessage ( $userId, $channel_id, $messages, $msgIds )
{
    global $access_token;
    $channel = new Channel ( $access_token ) ;
...
function test_pushMessageToUser ( $userId, $messages, $msgKeys )
{
    global $access_token;
    $channel = new Channel ( $access_token ) ;
...
function test_messageCount ( $userId  )
{
    global $access_token;
    $channel = new Channel ( $access_token ) ;
    //$optional [ Channel::CHANNEL_ID ] = 4152049051604943232;
...
function test_createGroup($group_name, $info)
{
    global $access_token;
    $channel = new Channel($access_token);
